...
class PublicTransport:
    ...
    def info(self):
        ...
        марке, цвете, годе выпуска и мощности двигателя
        """
        info = f'{self.brand, self.color, self.year, self._engine_power}'
        return info
...
class Bus(PublicTransport):
    ...
    def park(self):
        """
        Свойство, которое будет возвращать значение park,
        а при присвоении проверять номер парка, что он в диапазоне от 1000 до 9999
        """
        return self.__park
...
class Tram(PublicTransport):
    ...
    def how_long(self):
        """
        Свойство, которое вычисляет время прохождения маршрута по формуле max_speed/(4*path)
        """
