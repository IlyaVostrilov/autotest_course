...
class Segment:
    ...
    def length(self):
        """
        Возвращает длину отрезка по теореме Пифагора, с округлением до 2 знаков после запятой
        """
    ...
    def y_axis_intersection(self):
        ...
        """
        if self.first_point[0] > 0 and self.second_point[0] > 0:
            return False
        elif self.first_point[0] < 0 and self.second_point[0] < 0:
            return False
        else:
            return True
    ...
    def x_axis_intersection(self):
        ...
        """
        if self.first_point[1] > 0 and self.second_point[1] > 0:
            return False
        elif self.first_point[1] < 0 and self.second_point[1] < 0:
            return False
        else:
            return True
