...
def letter_stat(our_str):
    """
    Функция возвращает словарь, в котором ключами являются буквы, а значениями - количество раз,
    сколько эта буква встречается в слове.
    :param our_str: слово, в котором считаем буквы.
    :return: словарь формата {буква: кол-во вхождений этой буквы в строку}
    """
    letters_dict = {}
