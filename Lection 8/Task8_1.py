...
def treatment_sum(our_tuple: tuple) -> str:
    """
    Функция для сложения переменных
    :param our_tuple: набор данных для сложения
    :return: result - возвращает результат сложения
    """
    try:
